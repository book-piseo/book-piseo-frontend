...
import { PageableResponse } from '@models/page.model';
import { ContentsInfoResponse } from '@models/contents.model';
import { getTeamContentsInfo } from '@apis/teamApi';

type TeamBookReviewResponse = PageableResponse & { content: ContentsInfoResponse[] };

const TeamBookReviewList = ({ teamId }: { teamId: string }) => {
	const [pageNumber, setPageNumber] = useState(0);
	const [result, setResult] = useState<TeamBookReviewResponse | null>(null);
